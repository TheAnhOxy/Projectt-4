                    ...
                    <form id="listForm">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" placeholder="Họ và tên" id="HoVaTen" name="fullName">
                            </div>
                            <div class="col">
                        ...
                        <input type="text" class="form-control mt-3" placeholder="Số điện thoại" id="sdt" name="phone">
                        <span class="text-danger" id="errorSdt">*</span>
                        <input type="text" class="form-control mt-3" placeholder="Nội dung" id="nd" name="demand">
                        <button class="btn btn-primary px-4 mt-3" id="btnGuiLienHe">
                            Gửi liên hệ
                        </button>
                    </form>
                </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var nameInput = document.getElementById('HoVaTen');
        ...
        function checkName() {
            ...
            if (name === "") {
                errorName.innerHTML = "Tên không được rỗng !";
                return false;
            } else {
                errorName.innerHTML = "*";
                return true;
        ...
        function checkSdt() {
            var sdtt = sdtInput.value;
            if (sdtt === "") {
                errorSdt.innerHTML = "Số điện thoại không được rỗng !";
                return false;
            } else {
                errorSdt.innerHTML = "*";
                return true;
        ...
        sdtInput.addEventListener('blur', checkSdt);

        btn.addEventListener('click', function(e) {
            e.preventDefault();

            var isNameValid = checkName();
            var isPhoneValid = checkSdt();

            // thoa man dk name va sdt
    ...
    function addNewCustomer(data) {
        $.ajax({
            type: "POST",
            url: '${customerAPI}/newCustomer',
            data: JSON.stringify(data),
            contentType: "application/json",
            success: function() {
                console.log("Success");
                alert("Sent contact information successfully.");
            },
            error: function() {
                console.log("Error");
    ...
    <%--function addNewCustomer(data) {--%>
        <%--$.ajax({--%>
            ...
            <%--success: function() {--%>
                <%--console.log("Success");--%>
                <%--alert("Sent contaction Successfully");--%>
